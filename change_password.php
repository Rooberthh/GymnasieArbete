                ...
                <div class="row">
                  <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                      <input type="password" name="password_current" id="password_current" value="<?php echo escape($user->data()->email); ?>" class="form-control input-sm" placeholder="Current Password">
                    </div>
                  </div>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                      <input type="password" name="password_new" id="password_new" value="<?php echo escape($user->data()->password); ?>" class="form-control input-sm" placeholder="New Password">
                    </div>
                  </div>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                      <input type="password" name="password_new_again" id="password_new_again" value="<?php echo escape($user->data()->email); ?>" class="form-control input-sm" placeholder="Repeat new password">
                    </div>
                  </div>
                </div>
